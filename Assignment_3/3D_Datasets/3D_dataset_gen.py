...
for i in range(10,40, 2):
    ...
    fig.suptitle("Locally Linear Embeddings for S curve with {} neighbors".format(params['n_neighbors']), size=16)
    ...
    fig.suptitle("Locally Linear Embeddings for Swiss Curve with {} neighbors".format(params['n_neighbors']), size=16)
